...
/******/ 	var hotCurrentHash = "42150db5d168ff72a66c"; // eslint-disable-line no-unused-vars
			...
			_react2.default.createElement(
				...
				_react2.default.createElement(
					...
					_react2.default.createElement(
						'figure',
						{ className: 'avatar' },
						_react2.default.createElement('img', { src: __webpack_require__(14)("./" + _resume2.default.avatar), alt: _resume2.default.name })
					),
					_react2.default.createElement(
						'h1',
						{ className: 'header' },
...
/***/ function(module, exports, __webpack_require__) {
	...
	var map = {
		"./berkin-berkcan-cirak.jpg": 15,
		"./berkin-berkcan.cirak-2.jpg": 16,
		"./social/dribbble.svg": 17,
